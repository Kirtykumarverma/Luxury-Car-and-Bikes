...
<nav class="navbar navbar-expand-lg navbar-inverse bg-light sticky-top">
    <a class="navbar-brand" href="http://localhost:${pageContext.request.localPort}${pageContext.request.contextPath}/index.jsp">Luxury Cars and Bikes</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/EcomProj/index.jsp"><i class="fas fa-home"></i>Home<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
